...
public class SSLIOPCorbaloc
{
        ...
        throws org.omg.CORBA.ORBPackage.InvalidName
    {
        ...
        if (corbaloc_URL.startsWith("corbaloc:ssliop:")) {
            corbaloc = corbaloc_URL.substring(16);
        ...
        throws org.omg.CORBA.ORBPackage.InvalidName
    {
        ...
        TaggedComponent[] components = new TaggedComponent[1];
