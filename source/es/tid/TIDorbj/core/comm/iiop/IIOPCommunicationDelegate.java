 ...
 *
 */
public class IIOPCommunicationDelegate extends CommunicationDelegate {

    private IIOPIOR                iiopReference;	
	private IIOPCommunicationLayer communicationLayer;
	
	/**
	 * 
	 */
	public IIOPCommunicationDelegate( IIOPCommunicationLayer communicationLayer ) {
		super();
    ...
    public synchronized IIOPIOR getIIOPReference(){
        if ( this.iiopReference == null ){
            this.iiopReference = new IIOPIOR();
            this.iiopReference.assign( super.reference );
        }
        return this.iiopReference;
    }
	...
	public Object duplicate(Object self) {
        IIOPCommunicationDelegate delegate; 
		delegate = new IIOPCommunicationDelegate( this.communicationLayer );
