...
/**
 * Entry point for the IIOPCommunicationLayer
 * 
 * @author Juan Pablo Rojas
 *  
 * */
public class IIOPCommunicationLayer implements CommunicationLayer {

    public static String ID = "IIOPCommunicationLayer";
    ...
    private IIOPCommunicationLayerPropertiesInfo propertiesInfo;

	/**
	 * 
	 */
	public IIOPCommunicationLayer() {
	...
	public void setORB(TIDORB orb) {
		if ( orb != null ){
			...
			this.orb = orb;
            this.propertiesInfo = IIOPCommunicationLayerPropertiesInfo.getInstance();
	 ...
	 */
	public CommunicationDelegate createDelegate(String url, Properties info) throws CommunicationException {
	 ...
	 */
	public CommunicationDelegate createDelegate(IOR ior) throws CommunicationException {
		IIOPCommunicationDelegate delegate = new IIOPCommunicationDelegate( this );
	 ...
	 */
	public CommunicationDelegate createDelegate(IOR ior, Properties info) throws CommunicationException {
	 ...
	 */
	public boolean accepts(String url) throws CommunicationException {
	    return url!= null && 
			 ( url.startsWith( "corbaloc:iiop:"   ) ||
	 ...
	 */
	public boolean accepts(IOR ior) throws CommunicationException {
            boolean accepted;
	 ...
	 */
	public String createURL(String repositoryId, ObjectKey key) throws CommunicationException {
	 ...
	 */
	public String getId() {
		return IIOPCommunicationLayer.ID;
	}
    ...
    public String toString(){
        ...
        StringBuffer toString = new StringBuffer( "[ " )
            .append( IIOPCommunicationLayer.ID )
                .append( " ( iiop://" )
                    .append( hostSpec )
                    .append( ':' )
                    .append( this.propertiesInfo.port.value )
                .append( " )" )
            .append( " ]");
