 ...
 *
 */
public class IIOPLocateResponseHandler extends QueuedLocateResponseHandler implements LocateResponseHandler {
    ...
    public IIOPLocateResponseHandler( IIOPConnection conn, 
                                      GIOPVersion version, 
                                      RequestId requestId, 
                                      ObjectKey objectKey)
    {
    ...
    public void setConnection( IIOPConnection conn ){
        this.conn = conn;
    }
