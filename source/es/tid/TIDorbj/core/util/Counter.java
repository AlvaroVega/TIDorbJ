...
public class Counter
{
    ...
    synchronized public boolean isZero()
    {
        return (m_value == 0);
    }

    synchronized public boolean isNonZero()
    {
        return (m_value != 0);
    }
     ...
     */
    synchronized public int postInc()
    {
        int post_value = m_value;
        m_value++;
        return post_value;
    }
    ...
    synchronized public int postDec()
    {
        int post_value = m_value;
