...
public class RelativeRoundtripTimeoutPolicyImpl 
	extends org.omg.Messaging.RelativeRoundtripTimeoutPolicyLocalBase
{

    long m_value;

    public RelativeRoundtripTimeoutPolicyImpl(long val)
    {
        m_value = val;
    }
    ...
    public static RelativeRoundtripTimeoutPolicyImpl createPolicy(Any val)
    throws org.omg.CORBA.PolicyError
    {
	    try {
	        long policy_value = org.omg.TimeBase.TimeTHelper.extract(val);
	
	        return new RelativeRoundtripTimeoutPolicyImpl(policy_value);
