...
public class ThreadPolicyImpl
extends org.omg.PortableServer.ThreadPolicyLocalBase
{

    private org.omg.PortableServer.ThreadPolicyValue m_value;

    public ThreadPolicyImpl(org.omg.PortableServer.ThreadPolicyValue value)
    {
        m_value = value;
    }
    ...
    {
        return new ThreadPolicyImpl(m_value);
    }
