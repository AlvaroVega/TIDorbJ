...
public class ImplicitActivationPolicyImpl 
   extends org.omg.PortableServer.ImplicitActivationPolicyLocalBase
{
    ...
    {
        return new ImplicitActivationPolicyImpl(m_value);
    }
