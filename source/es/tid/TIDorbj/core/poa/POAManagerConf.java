...
public class POAManagerConf
{
    ...
    private POAManagerConfListener m_listener = null;

    protected POAManagerConf(int min_threads, int max_threads,
    ...
    public void setListener(POAManagerConfListener l)
    {
        m_listener = l;
    }
