...
/**
 * TIDorb ContextList pseudobject implementation.
 * 
...
public class ContextListImpl extends org.omg.CORBA.ContextList
{
        ...
        throws org.omg.CORBA.Bounds
    {
        ...
        return (String) m_elements.elementAt(index);
    }
        ...
        throws org.omg.CORBA.Bounds
    {
        ...
        m_elements.removeElementAt(index);
    }

    protected java.util.Vector m_elements;
}