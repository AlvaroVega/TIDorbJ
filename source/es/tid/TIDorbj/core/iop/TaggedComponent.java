...
/**
 * TaggedComponent structure defined in the GIOP Module.
 * 
...
public class TaggedComponent
{
    ...
    public es.tid.TIDorbj.core.cdr.Encapsulation m_component_data;
    ...
    public TaggedComponent(int tag,
                           es.tid.TIDorbj.core.cdr.Encapsulation component_data)
    {
        m_tag = tag;
    ...
    {
        output.write_ulong(m_tag);
        output.writeEncapsulation(m_component_data);
    }

    public void partialRead(es.tid.TIDorbj.core.cdr.CDRInputStream input)
    {
        m_component_data = input.readEncapsulation();
    }

    public static void skip(es.tid.TIDorbj.core.cdr.CDRInputStream input)
    {
        input.skipUlong(); //tag
        input.skipEncapsulation(); // component_data
    }
