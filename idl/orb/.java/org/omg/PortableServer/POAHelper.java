...
abstract public class POAHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "POA");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, POA value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static POA extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    POA value = narrow(obj);
    return value;
  };

  public static POA read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, POA val) {
  ...
  private static POA narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
