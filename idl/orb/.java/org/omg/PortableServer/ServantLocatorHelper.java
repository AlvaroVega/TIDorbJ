//
// ServantLocatorHelper.java (helper)
//
...
abstract public class ServantLocatorHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "ServantLocator");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, ServantLocator value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static ServantLocator extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    ServantLocator value = narrow(obj);
    return value;
  };

  public static ServantLocator read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, ServantLocator val) {
  ...
  private static ServantLocator narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof ServantLocator) {
