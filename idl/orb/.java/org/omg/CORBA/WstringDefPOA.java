...
abstract public class WstringDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements WstringDefOperations {

  public WstringDef _this() {
    return WstringDefHelper.narrow(super._this_object());
  };

  public WstringDef _this(org.omg.CORBA.ORB orb) {
    return WstringDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    ...
    _methods.put("_get_type", new Integer(2));
    _methods.put("_get_def_kind", new Integer(3));
