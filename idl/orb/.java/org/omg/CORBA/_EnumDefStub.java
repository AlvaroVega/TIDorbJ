...
public class _EnumDefStub
 ...
 implements EnumDef {
  ...
  public java.lang.String[] members() {
    ...
    _request.set_return_type(org.omg.CORBA.EnumMemberSeqHelper.type());
    _request.invoke();
    ...
    _result = org.omg.CORBA.EnumMemberSeqHelper.extract(_request.return_value());
    return _result;  }
  ...
  public void members(java.lang.String[] value) {
    ...
    org.omg.CORBA.EnumMemberSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
