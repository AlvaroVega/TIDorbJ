...
abstract public class ValueBoxDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements ValueBoxDefOperations {

  public ValueBoxDef _this() {
    return ValueBoxDefHelper.narrow(super._this_object());
  };

  public ValueBoxDef _this(org.omg.CORBA.ORB orb) {
    return ValueBoxDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    _methods.put("_get_original_type_def", new Integer(0));
    _methods.put("_set_original_type_def", new Integer(1));
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      org.omg.CORBA.IDLType _result = this.original_type_def();
