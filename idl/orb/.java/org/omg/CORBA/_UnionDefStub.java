...
public class _UnionDefStub
 ...
 implements UnionDef {
  ...
  public org.omg.CORBA.TypeCode discriminator_type() {
    org.omg.CORBA.Request _request = this._request("_get_discriminator_type");
  ...
  public org.omg.CORBA.IDLType discriminator_type_def() {
    org.omg.CORBA.Request _request = this._request("_get_discriminator_type_def");
  ...
  public void discriminator_type_def(org.omg.CORBA.IDLType value) {
    org.omg.CORBA.Request _request = this._request("_set_discriminator_type_def");
  ...
  public org.omg.CORBA.UnionMember[] members() {
    org.omg.CORBA.Request _request = this._request("_get_members");
    _request.set_return_type(org.omg.CORBA.UnionMemberSeqHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    ...
    _result = org.omg.CORBA.UnionMemberSeqHelper.extract(_request.return_value());
    return _result;  }

  public void members(org.omg.CORBA.UnionMember[] value) {
    org.omg.CORBA.Request _request = this._request("_set_members");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.UnionMemberSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
