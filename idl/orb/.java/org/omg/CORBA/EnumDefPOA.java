...
abstract public class EnumDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements EnumDefOperations {

  public EnumDef _this() {
    return EnumDefHelper.narrow(super._this_object());
  };

  public EnumDef _this(org.omg.CORBA.ORB orb) {
    return EnumDefHelper.narrow(super._this_object(orb));
  };
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      java.lang.String[] _result = this.members();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.EnumMemberSeqHelper.insert(_resultAny, _result);
    ...
    case 1: {
      ...
      $value.type(org.omg.CORBA.EnumMemberSeqHelper.type());
      _params.add_value("value", $value, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      java.lang.String[] value;
      value = org.omg.CORBA.EnumMemberSeqHelper.extract($value);
      this.members(value);
      return;
    }
    case 2: {
