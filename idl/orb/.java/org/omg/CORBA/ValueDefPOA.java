...
abstract public class ValueDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements ValueDefOperations {

  public ValueDef _this() {
    return ValueDefHelper.narrow(super._this_object());
  };

  public ValueDef _this(org.omg.CORBA.ORB orb) {
    return ValueDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    _methods.put("_get_supported_interfaces", new Integer(0));
    _methods.put("_set_supported_interfaces", new Integer(1));
    _methods.put("_get_initializers", new Integer(2));
    _methods.put("_set_initializers", new Integer(3));
    _methods.put("_get_base_value", new Integer(4));
    _methods.put("_set_base_value", new Integer(5));
    _methods.put("_get_abstract_base_values", new Integer(6));
    _methods.put("_set_abstract_base_values", new Integer(7));
    _methods.put("_get_is_abstract", new Integer(8));
    _methods.put("_set_is_abstract", new Integer(9));
    _methods.put("_get_is_custom", new Integer(10));
    _methods.put("_set_is_custom", new Integer(11));
    _methods.put("_get_is_truncatable", new Integer(12));
    _methods.put("_set_is_truncatable", new Integer(13));
    _methods.put("is_a", new Integer(14));
    _methods.put("describe_value", new Integer(15));
    _methods.put("create_value_member", new Integer(16));
    _methods.put("create_attribute", new Integer(17));
    _methods.put("create_operation", new Integer(18));
    _methods.put("lookup", new Integer(19));
    _methods.put("contents", new Integer(20));
    _methods.put("lookup_name", new Integer(21));
    _methods.put("describe_contents", new Integer(22));
    _methods.put("create_module", new Integer(23));
    _methods.put("create_constant", new Integer(24));
    _methods.put("create_struct", new Integer(25));
    _methods.put("create_union", new Integer(26));
    _methods.put("create_enum", new Integer(27));
    _methods.put("create_alias", new Integer(28));
    _methods.put("create_interface", new Integer(29));
    _methods.put("create_value", new Integer(30));
    _methods.put("create_value_box", new Integer(31));
    _methods.put("create_exception", new Integer(32));
    _methods.put("create_native", new Integer(33));
    _methods.put("_get_def_kind", new Integer(34));
    _methods.put("destroy", new Integer(35));
    _methods.put("_get_id", new Integer(36));
    _methods.put("_set_id", new Integer(37));
    _methods.put("_get_name", new Integer(38));
    _methods.put("_set_name", new Integer(39));
    _methods.put("_get_version", new Integer(40));
    _methods.put("_set_version", new Integer(41));
    _methods.put("_get_defined_in", new Integer(42));
    _methods.put("_get_absolute_name", new Integer(43));
    _methods.put("_get_containing_repository", new Integer(44));
    _methods.put("describe", new Integer(45));
    _methods.put("move", new Integer(46));
    _methods.put("_get_type", new Integer(47));
  }
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      org.omg.CORBA.InterfaceDef[] _result = this.supported_interfaces();
    ...
    case 2: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.Initializer[] _result = this.initializers();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.InitializerSeqHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 3: {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $value = _orb().create_any();
      $value.type(org.omg.CORBA.InitializerSeqHelper.type());
      _params.add_value("value", $value, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CORBA.Initializer[] value;
      value = org.omg.CORBA.InitializerSeqHelper.extract($value);
    ...
    case 4: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.ValueDef _result = this.base_value();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
    ...
    case 5: {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $value = _orb().create_any();
      $value.type(org.omg.CORBA.ValueDefHelper.type());
      _params.add_value("value", $value, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CORBA.ValueDef value;
      value = org.omg.CORBA.ValueDefHelper.extract($value);
    ...
    case 6: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.ValueDef[] _result = this.abstract_base_values();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.ValueDefSeqHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 7: {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $value = _orb().create_any();
      $value.type(org.omg.CORBA.ValueDefSeqHelper.type());
      _params.add_value("value", $value, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CORBA.ValueDef[] value;
      value = org.omg.CORBA.ValueDefSeqHelper.extract($value);
    ...
    case 10: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      boolean _result = this.is_custom();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      _resultAny.insert_boolean(_result);
      _request.set_result(_resultAny);
      return;
    ...
    case 12: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      boolean _result = this.is_truncatable();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      _resultAny.insert_boolean(_result);
      _request.set_result(_resultAny);
      return;
    ...
    case 15: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.ValueDefPackage.FullValueDescription _result = this.describe_value();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
    ...
    case 16: {
      ...
      org.omg.CORBA.Any $access = _orb().create_any();
      $access.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_short));
      _params.add_value("access", $access, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      java.lang.String id;
      id = $id.extract_string();
      ...
      short access;
      access = $access.extract_short();
      org.omg.CORBA.ValueMemberDef _result = this.create_value_member(id, name, version, type, access);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.ValueMemberDefHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 17: {
