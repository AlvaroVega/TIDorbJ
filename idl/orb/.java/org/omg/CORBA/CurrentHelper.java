...
abstract public class CurrentHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, Current value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static Current extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    Current value = narrow(obj);
    return value;
  };

  public static Current read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, Current val) {
  ...
  private static Current narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      _CurrentStub result = (_CurrentStub)new _CurrentStub();
