...
public class StringValueHelper
  ...
  private static String  _id = "IDL:CORBA/StringValue:1.0";
  ...
  public static org.omg.CORBA.TypeCode type(){
    if (_type == null){
          ...
          _type = org.omg.CORBA.ORB.init ().create_value_box_tc (_id, "StringValue", _type);    }
    return _type;
  }
  ...
  public void write_value(org.omg.CORBA.portable.OutputStream os, java.io.Serializable _value){
    if (_value instanceof java.lang.String){
             os.write_string((java.lang.String) _value);
    }
