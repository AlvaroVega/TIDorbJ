...
abstract public class ConstantDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements ConstantDefOperations {

  public ConstantDef _this() {
    return ConstantDefHelper.narrow(super._this_object());
  };

  public ConstantDef _this(org.omg.CORBA.ORB orb) {
    return ConstantDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    ...
    _methods.put("_get_value", new Integer(3));
    _methods.put("_set_value", new Integer(4));
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 3: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.Any _result = this.value();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
