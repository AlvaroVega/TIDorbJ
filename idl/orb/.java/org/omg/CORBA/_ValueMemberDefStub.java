...
public class _ValueMemberDefStub
 ...
 implements ValueMemberDef {
  ...
  public short access() {
    org.omg.CORBA.Request _request = this._request("_get_access");
  ...
  public void access(short value) {
    org.omg.CORBA.Request _request = this._request("_set_access");
    org.omg.CORBA.Any $value = _request.add_in_arg();
