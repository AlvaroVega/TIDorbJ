...
public class _StructDefStub
 extends org.omg.CORBA.portable.ObjectImpl
 implements StructDef {
  ...
  public org.omg.CORBA.StructMember[] members() {
    ...
    _request.set_return_type(org.omg.CORBA.StructMemberSeqHelper.type());
    _request.invoke();
    ...
    _result = org.omg.CORBA.StructMemberSeqHelper.extract(_request.return_value());
    return _result;  }

  public void members(org.omg.CORBA.StructMember[] value) {
    org.omg.CORBA.Request _request = this._request("_set_members");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.StructMemberSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
