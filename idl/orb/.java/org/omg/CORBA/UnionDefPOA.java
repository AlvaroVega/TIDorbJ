...
abstract public class UnionDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements UnionDefOperations {

  public UnionDef _this() {
    return UnionDefHelper.narrow(super._this_object());
  };

  public UnionDef _this(org.omg.CORBA.ORB orb) {
    return UnionDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    _methods.put("_get_discriminator_type", new Integer(0));
    _methods.put("_get_discriminator_type_def", new Integer(1));
    _methods.put("_set_discriminator_type_def", new Integer(2));
    _methods.put("_get_members", new Integer(3));
    _methods.put("_set_members", new Integer(4));
    ...
    _methods.put("_get_type", new Integer(18));
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      org.omg.CORBA.TypeCode _result = this.discriminator_type();
    ...
    case 1: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.IDLType _result = this.discriminator_type_def();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
    ...
    case 3: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.UnionMember[] _result = this.members();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.UnionMemberSeqHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 4: {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $value = _orb().create_any();
      $value.type(org.omg.CORBA.UnionMemberSeqHelper.type());
      _params.add_value("value", $value, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CORBA.UnionMember[] value;
      value = org.omg.CORBA.UnionMemberSeqHelper.extract($value);
      this.members(value);
      return;
    }
    case 5: {
