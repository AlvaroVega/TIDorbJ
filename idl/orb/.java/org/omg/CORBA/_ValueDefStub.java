...
public class _ValueDefStub
 ...
 implements ValueDef {
  ...
  public org.omg.CORBA.InterfaceDef[] supported_interfaces() {
    org.omg.CORBA.Request _request = this._request("_get_supported_interfaces");
  ...
  public void supported_interfaces(org.omg.CORBA.InterfaceDef[] value) {
    org.omg.CORBA.Request _request = this._request("_set_supported_interfaces");
  ...
  public org.omg.CORBA.Initializer[] initializers() {
    org.omg.CORBA.Request _request = this._request("_get_initializers");
    _request.set_return_type(org.omg.CORBA.InitializerSeqHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    ...
    _result = org.omg.CORBA.InitializerSeqHelper.extract(_request.return_value());
    return _result;  }

  public void initializers(org.omg.CORBA.Initializer[] value) {
    org.omg.CORBA.Request _request = this._request("_set_initializers");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.InitializerSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
  ...
  public org.omg.CORBA.ValueDef base_value() {
    org.omg.CORBA.Request _request = this._request("_get_base_value");
  ...
  public void base_value(org.omg.CORBA.ValueDef value) {
    org.omg.CORBA.Request _request = this._request("_set_base_value");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.ValueDefHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
  ...
  public org.omg.CORBA.ValueDef[] abstract_base_values() {
    org.omg.CORBA.Request _request = this._request("_get_abstract_base_values");
    _request.set_return_type(org.omg.CORBA.ValueDefSeqHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    ...
    org.omg.CORBA.ValueDef[] _result;
    _result = org.omg.CORBA.ValueDefSeqHelper.extract(_request.return_value());
    return _result;  }

  public void abstract_base_values(org.omg.CORBA.ValueDef[] value) {
    org.omg.CORBA.Request _request = this._request("_set_abstract_base_values");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.ValueDefSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
  ...
  public boolean is_custom() {
    org.omg.CORBA.Request _request = this._request("_get_is_custom");
    _request.set_return_type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_boolean));
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
  ...
  public void is_custom(boolean value) {
    org.omg.CORBA.Request _request = this._request("_set_is_custom");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    $value.insert_boolean(value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
  ...
  public boolean is_truncatable() {
    org.omg.CORBA.Request _request = this._request("_get_is_truncatable");
    _request.set_return_type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_boolean));
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
  ...
  public void is_truncatable(boolean value) {
    org.omg.CORBA.Request _request = this._request("_set_is_truncatable");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    $value.insert_boolean(value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
  ...
  public org.omg.CORBA.ValueDefPackage.FullValueDescription describe_value() {
    org.omg.CORBA.Request _request = this._request("describe_value");
  ...
  public org.omg.CORBA.ValueMemberDef create_value_member(java.lang.String id, java.lang.String name, java.lang.String version, org.omg.CORBA.IDLType type, short access) {
    org.omg.CORBA.Request _request = this._request("create_value_member");
    _request.set_return_type(org.omg.CORBA.ValueMemberDefHelper.type());
    org.omg.CORBA.Any $id = _request.add_named_in_arg("id");
    $id.insert_string(id);
    ...
    org.omg.CORBA.Any $access = _request.add_named_in_arg("access");
    $access.insert_short(access);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      if (_exception instanceof org.omg.CORBA.UnknownUserException) {
    ...
    _result = org.omg.CORBA.ValueMemberDefHelper.extract(_request.return_value());
    return _result;
  }
