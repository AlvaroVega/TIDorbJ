...
abstract public class RepositoryPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements RepositoryOperations {

  public Repository _this() {
    return RepositoryHelper.narrow(super._this_object());
  };

  public Repository _this(org.omg.CORBA.ORB orb) {
    return RepositoryHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    _methods.put("lookup_id", new Integer(0));
    _methods.put("get_canonical_typecode", new Integer(1));
    _methods.put("get_primitive", new Integer(2));
    _methods.put("create_string", new Integer(3));
    _methods.put("create_wstring", new Integer(4));
    _methods.put("create_sequence", new Integer(5));
    _methods.put("create_array", new Integer(6));
    _methods.put("create_fixed", new Integer(7));
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      org.omg.CORBA.Any $search_id = _orb().create_any();
      $search_id.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
      _params.add_value("search_id", $search_id, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      java.lang.String search_id;
      search_id = $search_id.extract_string();
      org.omg.CORBA.Contained _result = this.lookup_id(search_id);
    ...
    case 1: {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $tc = _orb().create_any();
      $tc.type(org.omg.CORBA.TypeCodeHelper.type());
      _params.add_value("tc", $tc, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CORBA.TypeCode tc;
      tc = org.omg.CORBA.TypeCodeHelper.extract($tc);
      org.omg.CORBA.TypeCode _result = this.get_canonical_typecode(tc);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
    ...
    case 2: {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $kind = _orb().create_any();
      $kind.type(org.omg.CORBA.PrimitiveKindHelper.type());
      _params.add_value("kind", $kind, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CORBA.PrimitiveKind kind;
      kind = org.omg.CORBA.PrimitiveKindHelper.extract($kind);
      org.omg.CORBA.PrimitiveDef _result = this.get_primitive(kind);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.PrimitiveDefHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 3: {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $bound = _orb().create_any();
      $bound.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_ulong));
      _params.add_value("bound", $bound, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      int bound;
      bound = $bound.extract_ulong();
      org.omg.CORBA.StringDef _result = this.create_string(bound);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.StringDefHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 4: {
      ...
      int bound;
      bound = $bound.extract_ulong();
      org.omg.CORBA.WstringDef _result = this.create_wstring(bound);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.WstringDefHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 5: {
      ...
      $bound.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_ulong));
      _params.add_value("bound", $bound, org.omg.CORBA.ARG_IN.value);
      org.omg.CORBA.Any $element_type = _orb().create_any();
      $element_type.type(org.omg.CORBA.IDLTypeHelper.type());
      _params.add_value("element_type", $element_type, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      int bound;
      bound = $bound.extract_ulong();
      org.omg.CORBA.IDLType element_type;
      element_type = org.omg.CORBA.IDLTypeHelper.extract($element_type);
      org.omg.CORBA.SequenceDef _result = this.create_sequence(bound, element_type);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.SequenceDefHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 6: {
      org.omg.CORBA.NVList _params = _orb().create_list(2);
      org.omg.CORBA.Any $length = _orb().create_any();
      $length.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_ulong));
      _params.add_value("length", $length, org.omg.CORBA.ARG_IN.value);
      org.omg.CORBA.Any $element_type = _orb().create_any();
      $element_type.type(org.omg.CORBA.IDLTypeHelper.type());
      _params.add_value("element_type", $element_type, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      int length;
      length = $length.extract_ulong();
      org.omg.CORBA.IDLType element_type;
      element_type = org.omg.CORBA.IDLTypeHelper.extract($element_type);
      org.omg.CORBA.ArrayDef _result = this.create_array(length, element_type);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.ArrayDefHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 7: {
      org.omg.CORBA.NVList _params = _orb().create_list(2);
      org.omg.CORBA.Any $digits = _orb().create_any();
      $digits.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_ushort));
      _params.add_value("digits", $digits, org.omg.CORBA.ARG_IN.value);
      org.omg.CORBA.Any $scale = _orb().create_any();
      $scale.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_short));
      _params.add_value("scale", $scale, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      short digits;
      digits = $digits.extract_ushort();
      short scale;
      scale = $scale.extract_short();
      org.omg.CORBA.FixedDef _result = this.create_fixed(digits, scale);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.FixedDefHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      return;
    }
    case 8: {
