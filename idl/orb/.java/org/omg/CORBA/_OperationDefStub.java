...
public class _OperationDefStub
 ...
 implements OperationDef {
  ...
  public org.omg.CORBA.TypeCode result() {
    org.omg.CORBA.Request _request = this._request("_get_result");
  ...
  public org.omg.CORBA.IDLType result_def() {
    org.omg.CORBA.Request _request = this._request("_get_result_def");
  ...
  public void result_def(org.omg.CORBA.IDLType value) {
    org.omg.CORBA.Request _request = this._request("_set_result_def");
  ...
  public org.omg.CORBA.ParameterDescription[] params() {
    org.omg.CORBA.Request _request = this._request("_get_params");
    _request.set_return_type(org.omg.CORBA.ParDescriptionSeqHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    ...
    _result = org.omg.CORBA.ParDescriptionSeqHelper.extract(_request.return_value());
    return _result;  }

  public void params(org.omg.CORBA.ParameterDescription[] value) {
    org.omg.CORBA.Request _request = this._request("_set_params");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.ParDescriptionSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
  ...
  public org.omg.CORBA.OperationMode mode() {
    org.omg.CORBA.Request _request = this._request("_get_mode");
    _request.set_return_type(org.omg.CORBA.OperationModeHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    ...
    _result = org.omg.CORBA.OperationModeHelper.extract(_request.return_value());
    return _result;  }

  public void mode(org.omg.CORBA.OperationMode value) {
    org.omg.CORBA.Request _request = this._request("_set_mode");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.OperationModeHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
  ...
  public java.lang.String[] contexts() {
    org.omg.CORBA.Request _request = this._request("_get_contexts");
    _request.set_return_type(org.omg.CORBA.ContextIdSeqHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    ...
    _result = org.omg.CORBA.ContextIdSeqHelper.extract(_request.return_value());
    return _result;  }

  public void contexts(java.lang.String[] value) {
    org.omg.CORBA.Request _request = this._request("_set_contexts");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.ContextIdSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
  ...
  public org.omg.CORBA.ExceptionDef[] exceptions() {
    org.omg.CORBA.Request _request = this._request("_get_exceptions");
    _request.set_return_type(org.omg.CORBA.ExceptionDefSeqHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    ...
    _result = org.omg.CORBA.ExceptionDefSeqHelper.extract(_request.return_value());
    return _result;  }

  public void exceptions(org.omg.CORBA.ExceptionDef[] value) {
    org.omg.CORBA.Request _request = this._request("_set_exceptions");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.ExceptionDefSeqHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
