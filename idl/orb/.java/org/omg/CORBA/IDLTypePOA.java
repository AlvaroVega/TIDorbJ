...
abstract public class IDLTypePOA
 extends org.omg.PortableServer.DynamicImplementation
 implements IDLTypeOperations {

  public IDLType _this() {
    return IDLTypeHelper.narrow(super._this_object());
  };

  public IDLType _this(org.omg.CORBA.ORB orb) {
    return IDLTypeHelper.narrow(super._this_object(orb));
  };
