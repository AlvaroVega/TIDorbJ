...
public class _AttributeDefStub
 ...
 implements AttributeDef {
  ...
  public org.omg.CORBA.IDLType type_def() {
    org.omg.CORBA.Request _request = this._request("_get_type_def");
  ...
  public void type_def(org.omg.CORBA.IDLType value) {
    org.omg.CORBA.Request _request = this._request("_set_type_def");
  ...
  public org.omg.CORBA.AttributeMode mode() {
    ...
    _request.set_return_type(org.omg.CORBA.AttributeModeHelper.type());
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
    };
    org.omg.CORBA.AttributeMode _result;
    _result = org.omg.CORBA.AttributeModeHelper.extract(_request.return_value());
    return _result;  }

  public void mode(org.omg.CORBA.AttributeMode value) {
    org.omg.CORBA.Request _request = this._request("_set_mode");
    org.omg.CORBA.Any $value = _request.add_in_arg();
    org.omg.CORBA.AttributeModeHelper.insert($value,value);
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      throw (org.omg.CORBA.SystemException) _exception;
