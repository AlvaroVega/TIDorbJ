...
public class ValueDefPOATie
 ...
 implements ValueDefOperations {
  ...
  public void supported_interfaces(org.omg.CORBA.InterfaceDef[] value) {
    this._delegate.supported_interfaces(value);
  }
  ...
  public void initializers(org.omg.CORBA.Initializer[] value) {
    this._delegate.initializers(value);
  }
  ...
  public void base_value(org.omg.CORBA.ValueDef value) {
    this._delegate.base_value(value);
  }
  ...
  public void abstract_base_values(org.omg.CORBA.ValueDef[] value) {
    this._delegate.abstract_base_values(value);
  }
  ...
  public void is_abstract(boolean value) {
    this._delegate.is_abstract(value);
  }
  ...
  public void is_custom(boolean value) {
    this._delegate.is_custom(value);
  }
  ...
  public void is_truncatable(boolean value) {
    this._delegate.is_truncatable(value);
  }

  public boolean is_a(java.lang.String id) {
    return this._delegate.is_a(
    id
    );
  };
  ...
  public org.omg.CORBA.ValueMemberDef create_value_member(java.lang.String id, java.lang.String name, java.lang.String version, org.omg.CORBA.IDLType type, short access) {
    return this._delegate.create_value_member(
    id, 
    name, 
    version, 
    type, 
  ...
  public org.omg.CORBA.AttributeDef create_attribute(java.lang.String id, java.lang.String name, java.lang.String version, org.omg.CORBA.IDLType type, org.omg.CORBA.AttributeMode mode) {
    return this._delegate.create_attribute(
    id, 
    name, 
    version, 
    type, 
  ...
  public org.omg.CORBA.OperationDef create_operation(java.lang.String id, java.lang.String name, java.lang.String version, org.omg.CORBA.IDLType result, org.omg.CORBA.OperationMode mode, org.omg.CORBA.ParameterDescription[] params, org.omg.CORBA.ExceptionDef[] exceptions, java.lang.String[] contexts) {
    return this._delegate.create_operation(
    id, 
    name, 
    version, 
    result, 
