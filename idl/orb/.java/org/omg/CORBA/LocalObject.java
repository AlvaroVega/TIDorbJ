...
public abstract class LocalObject implements org.omg.CORBA.Object 
{
  ...
  public String [] _ids()// new CORBA3.0 
  {
  ...
  {
  //    throw new org.omg.CORBA.NO_IMPLEMENT(); // new CORBA 3.0 
    String ids[]=_ids(); // new CORBA 3.0
  ...
  */
  ...
  public org.omg.CORBA.portable.InputStream 
    _invoke(org.omg.CORBA.portable.OutputStream output)
