...
abstract public class SequenceDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements SequenceDefOperations {

  public SequenceDef _this() {
    return SequenceDefHelper.narrow(super._this_object());
  };

  public SequenceDef _this(org.omg.CORBA.ORB orb) {
    return SequenceDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    _methods.put("_get_bound", new Integer(0));
    _methods.put("_set_bound", new Integer(1));
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 1: {
      ...
      $value.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_ulong));
      _params.add_value("value", $value, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      int value;
      value = $value.extract_ulong();
      this.bound(value);
      return;
    }
    case 2: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.TypeCode _result = this.element_type();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
    ...
    case 3: {
      org.omg.CORBA.NVList _params = _orb().create_list(0);
      _request.arguments(_params);
      org.omg.CORBA.IDLType _result = this.element_type_def();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
