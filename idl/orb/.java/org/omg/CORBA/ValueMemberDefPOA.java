//
// ValueMemberDefPOA.java (skeleton)
//
...
abstract public class ValueMemberDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements ValueMemberDefOperations {

  public ValueMemberDef _this() {
    return ValueMemberDefHelper.narrow(super._this_object());
  };

  public ValueMemberDef _this(org.omg.CORBA.ORB orb) {
    return ValueMemberDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    ...
    _methods.put("_get_access", new Integer(3));
    _methods.put("_set_access", new Integer(4));
