...
public class OperationDefPOATie
 ...
 implements OperationDefOperations {
  ...
  public void result_def(org.omg.CORBA.IDLType value) {
    this._delegate.result_def(value);
  }
  ...
  public void exceptions(org.omg.CORBA.ExceptionDef[] value) {
    this._delegate.exceptions(value);
  }
