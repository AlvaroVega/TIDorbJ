...
abstract public class DescriptionHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      members[0] = new org.omg.CORBA.StructMember("contained_object", org.omg.CORBA.ContainedHelper.type(), null);
      members[1] = new org.omg.CORBA.StructMember("kind", org.omg.CORBA.DefinitionKindHelper.type(), null);
      members[2] = new org.omg.CORBA.StructMember("value", org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_any), null);
  ...
  public static Description read(org.omg.CORBA.portable.InputStream is) {
    ...
    result.contained_object = org.omg.CORBA.ContainedHelper.read(is);
  ...
  public static void write(org.omg.CORBA.portable.OutputStream os, Description val) {
    org.omg.CORBA.ContainedHelper.write(os,val.contained_object);
