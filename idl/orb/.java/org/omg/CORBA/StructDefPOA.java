...
abstract public class StructDefPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements StructDefOperations {

  public StructDef _this() {
    return StructDefHelper.narrow(super._this_object());
  };

  public StructDef _this(org.omg.CORBA.ORB orb) {
    return StructDefHelper.narrow(super._this_object(orb));
  };
  ...
  static {
    _methods.put("_get_members", new Integer(0));
    _methods.put("_set_members", new Integer(1));
    _methods.put("_get_id", new Integer(2));
    _methods.put("_set_id", new Integer(3));
    _methods.put("_get_name", new Integer(4));
    _methods.put("_set_name", new Integer(5));
    _methods.put("_get_version", new Integer(6));
    _methods.put("_set_version", new Integer(7));
    _methods.put("_get_defined_in", new Integer(8));
    _methods.put("_get_absolute_name", new Integer(9));
    _methods.put("_get_containing_repository", new Integer(10));
    _methods.put("describe", new Integer(11));
    _methods.put("move", new Integer(12));
    _methods.put("_get_def_kind", new Integer(13));
    _methods.put("destroy", new Integer(14));
    _methods.put("_get_type", new Integer(15));
    _methods.put("lookup", new Integer(16));
    _methods.put("contents", new Integer(17));
    ...
    _methods.put("create_interface", new Integer(26));
    _methods.put("create_value", new Integer(27));
    _methods.put("create_value_box", new Integer(28));
    _methods.put("create_exception", new Integer(29));
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      org.omg.CORBA.StructMember[] _result = this.members();
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CORBA.StructMemberSeqHelper.insert(_resultAny, _result);
    ...
    case 1: {
      ...
      $value.type(org.omg.CORBA.StructMemberSeqHelper.type());
      _params.add_value("value", $value, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CORBA.StructMember[] value;
      value = org.omg.CORBA.StructMemberSeqHelper.extract($value);
      this.members(value);
      return;
    }
    case 2: {
