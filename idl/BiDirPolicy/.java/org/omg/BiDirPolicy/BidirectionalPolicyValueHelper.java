//
// BidirectionalPolicyValueHelper.java (helper)
//
...
abstract public class BidirectionalPolicyValueHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "BidirectionalPolicyValue", original_type);
    }
    return _type;
  };
