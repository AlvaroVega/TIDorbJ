...
public class DynUnionLocalTie
 extends DynUnionLocalBase
 {

  private DynUnionOperations _delegate;
  public DynUnionLocalTie(DynUnionOperations delegate) {
  ...
  public org.omg.DynamicAny.DynAny get_discriminator() {
    return this._delegate.get_discriminator(
    );
  };

  public void set_discriminator(org.omg.DynamicAny.DynAny d)
    throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch {
    this._delegate.set_discriminator(
    d
    );
  };
  ...
  public void set_to_default_member()
    throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch {
    this._delegate.set_to_default_member(
    );
  };

  public void set_to_no_active_member()
    throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch {
    this._delegate.set_to_no_active_member(
    );
  };

  public boolean has_no_active_member() {
    return this._delegate.has_no_active_member(
    );
  };

  public org.omg.CORBA.TCKind discriminator_kind() {
    return this._delegate.discriminator_kind(
    );
  };

  public org.omg.DynamicAny.DynAny member()
    throws org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    return this._delegate.member(
    );
  };

  public java.lang.String member_name()
    throws org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    return this._delegate.member_name(
    );
  };

  public org.omg.CORBA.TCKind member_kind()
    throws org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    return this._delegate.member_kind(
    );
  };
