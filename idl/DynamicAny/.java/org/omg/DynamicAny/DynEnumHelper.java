...
abstract public class DynEnumHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "DynEnum");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, DynEnum value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static DynEnum extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    DynEnum value = narrow(obj);
    return value;
  };

  public static DynEnum read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, DynEnum val) {
  ...
  private static DynEnum narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof DynEnum) {
      return (DynEnum)obj;
    }
    throw new org.omg.CORBA.BAD_PARAM();
  }
