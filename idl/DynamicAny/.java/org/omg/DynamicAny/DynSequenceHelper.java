...
abstract public class DynSequenceHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "DynSequence");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, DynSequence value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static DynSequence extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    DynSequence value = narrow(obj);
    return value;
  };

  public static DynSequence read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, DynSequence val) {
  ...
  private static DynSequence narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof DynSequence) {
