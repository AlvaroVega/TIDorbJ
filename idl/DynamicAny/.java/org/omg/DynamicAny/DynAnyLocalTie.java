...
public class DynAnyLocalTie
 extends DynAnyLocalBase
 {

  private DynAnyOperations _delegate;
  public DynAnyLocalTie(DynAnyOperations delegate) {
    this._delegate = delegate;
  };

  public DynAnyOperations _delegate() {
