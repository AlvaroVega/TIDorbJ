//
// DynAnyFactoryHelper.java (helper)
//
...
abstract public class DynAnyFactoryHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "DynAnyFactory");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, DynAnyFactory value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static DynAnyFactory extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    DynAnyFactory value = narrow(obj);
    return value;
  };

  public static DynAnyFactory read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, DynAnyFactory val) {
  ...
  private static DynAnyFactory narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof DynAnyFactory) {
