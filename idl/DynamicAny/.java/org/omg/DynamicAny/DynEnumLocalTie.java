...
public class DynEnumLocalTie
 extends DynEnumLocalBase
 {

  private DynEnumOperations _delegate;
  public DynEnumLocalTie(DynEnumOperations delegate) {
    this._delegate = delegate;
  };

  public DynEnumOperations _delegate() {
    return this._delegate;
  };

  public java.lang.String get_as_string() {
    return this._delegate.get_as_string(
    );
  };

  public void set_as_string(java.lang.String value)
    throws org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    this._delegate.set_as_string(
    value
    );
  };

  public int get_as_ulong() {
    return this._delegate.get_as_ulong(
    );
  };

  public void set_as_ulong(int value)
    throws org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    this._delegate.set_as_ulong(
    value
    );
  };
