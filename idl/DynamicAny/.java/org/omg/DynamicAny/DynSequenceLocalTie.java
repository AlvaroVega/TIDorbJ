...
public class DynSequenceLocalTie
 extends DynSequenceLocalBase
 {

  private DynSequenceOperations _delegate;
  public DynSequenceLocalTie(DynSequenceOperations delegate) {
    this._delegate = delegate;
  };

  public DynSequenceOperations _delegate() {
    return this._delegate;
  };

  public int get_length() {
    return this._delegate.get_length(
    );
  };

  public void set_length(int len)
    throws org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    this._delegate.set_length(
    len
    );
  };

  public org.omg.CORBA.Any[] get_elements() {
    return this._delegate.get_elements(
    );
  };

  public void set_elements(org.omg.CORBA.Any[] value)
    throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch, org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    this._delegate.set_elements(
    value
    );
  };

  public org.omg.DynamicAny.DynAny[] get_elements_as_dyn_any() {
    return this._delegate.get_elements_as_dyn_any(
    );
  };

  public void set_elements_as_dyn_any(org.omg.DynamicAny.DynAny[] value)
    throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch, org.omg.DynamicAny.DynAnyPackage.InvalidValue {
    this._delegate.set_elements_as_dyn_any(
    value
    );
  };
