...
abstract public class DynAnyHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "DynAny");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, DynAny value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static DynAny extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    DynAny value = narrow(obj);
    return value;
  };

  public static DynAny read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, DynAny val) {
  ...
  private static DynAny narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof DynAny) {
      return (DynAny)obj;
    }
    throw new org.omg.CORBA.BAD_PARAM();
  }
