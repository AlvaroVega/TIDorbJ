...
abstract public class DynArrayHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "DynArray");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, DynArray value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static DynArray extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    DynArray value = narrow(obj);
    return value;
  };

  public static DynArray read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, DynArray val) {
  ...
  private static DynArray narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
