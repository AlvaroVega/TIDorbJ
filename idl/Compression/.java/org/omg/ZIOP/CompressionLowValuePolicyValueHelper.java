//
// CompressionLowValuePolicyValueHelper.java (helper)
//
...
abstract public class CompressionLowValuePolicyValueHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "CompressionLowValuePolicyValue", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/CompressionLowValuePolicyValue:1.0";
  };
