//
// CompressionLevelHelper.java (helper)
//
...
abstract public class CompressionLevelHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "CompressionLevel", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/Compression/CompressionLevel:1.0";
  };
