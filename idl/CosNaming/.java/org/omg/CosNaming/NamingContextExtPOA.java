//
// NamingContextExtPOA.java (skeleton)
//
...
abstract public class NamingContextExtPOA
 ...
 implements NamingContextExtOperations {
  ...
  static {
    ...
    _methods.put("rebind", new Integer(5));
    _methods.put("bind_context", new Integer(6));
    _methods.put("rebind_context", new Integer(7));
    _methods.put("resolve", new Integer(8));
    _methods.put("unbind", new Integer(9));
    _methods.put("new_context", new Integer(10));
    _methods.put("bind_new_context", new Integer(11));
    _methods.put("destroy", new Integer(12));
    _methods.put("list", new Integer(13));
  }
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      java.lang.String _result = this.to_string(n);
    ...
    case 1: {
      try {
      org.omg.CORBA.NVList _params = _orb().create_list(1);
      org.omg.CORBA.Any $sn = _orb().create_any();
      $sn.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
      _params.add_value("sn", $sn, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      java.lang.String sn;
      sn = $sn.extract_string();
      org.omg.CosNaming.NameComponent[] _result = this.to_name(sn);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CosNaming.NameHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
      } catch(org.omg.CosNaming.NamingContextPackage.InvalidName _exception) {
        org.omg.CORBA.Any _exceptionAny = _orb().create_any();
        org.omg.CosNaming.NamingContextPackage.InvalidNameHelper.insert(_exceptionAny, _exception);
    ...
    case 2: {
      ...
      org.omg.CORBA.Any $addr = _orb().create_any();
      $addr.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
      _params.add_value("addr", $addr, org.omg.CORBA.ARG_IN.value);
      org.omg.CORBA.Any $sn = _orb().create_any();
      $sn.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
      _params.add_value("sn", $sn, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      java.lang.String addr;
      addr = $addr.extract_string();
      java.lang.String sn;
      sn = $sn.extract_string();
      java.lang.String _result = this.to_url(addr, sn);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      _resultAny.insert_string(_result);
      _request.set_result(_resultAny);
      } catch(org.omg.CosNaming.NamingContextExtPackage.InvalidAddress _exception) {
        org.omg.CORBA.Any _exceptionAny = _orb().create_any();
        org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHelper.insert(_exceptionAny, _exception);
        _request.set_exception(_exceptionAny);
      } catch(org.omg.CosNaming.NamingContextPackage.InvalidName _exception) {
        org.omg.CORBA.Any _exceptionAny = _orb().create_any();
        org.omg.CosNaming.NamingContextPackage.InvalidNameHelper.insert(_exceptionAny, _exception);
    ...
    case 3: {
      ...
      java.lang.String sn;
      sn = $sn.extract_string();
      org.omg.CORBA.Object _result = this.resolve_str(sn);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
