//
// NamingContextHelper.java (helper)
//
...
abstract public class NamingContextHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "NamingContext");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, NamingContext value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static NamingContext extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    NamingContext value = narrow(obj);
    return value;
  };

  public static NamingContext read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, NamingContext val) {
  ...
  private static NamingContext narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      _NamingContextStub result = (_NamingContextStub)new _NamingContextStub();
      ((org.omg.CORBA.portable.ObjectImpl) result)._set_delegate
        (((org.omg.CORBA.portable.ObjectImpl) obj)._get_delegate());
      return (NamingContext)result;
    }
    throw new org.omg.CORBA.BAD_PARAM();
  }
