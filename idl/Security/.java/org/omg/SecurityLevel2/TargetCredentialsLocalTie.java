//
// TargetCredentialsLocalTie.java (tie)
//
...
public class TargetCredentialsLocalTie
 extends TargetCredentialsLocalBase
 {

  private TargetCredentialsOperations _delegate;
  public TargetCredentialsLocalTie(TargetCredentialsOperations delegate) {
    this._delegate = delegate;
  };

  public TargetCredentialsOperations _delegate() {
    return this._delegate;
  };

  public org.omg.SecurityLevel2.Credentials initiating_credentials() {
    return this._delegate.initiating_credentials();
  }
