//
// ServiceSpecificNameHelper.java (helper)
//
...
abstract public class ServiceSpecificNameHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new ServiceSpecificNameHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof ServiceSpecificNameHolder){
          return ((ServiceSpecificNameHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "ServiceSpecificName", original_type);
    }
    return _type;
  };
