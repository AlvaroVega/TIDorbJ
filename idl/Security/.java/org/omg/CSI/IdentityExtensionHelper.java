//
// IdentityExtensionHelper.java (helper)
//
...
abstract public class IdentityExtensionHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new IdentityExtensionHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof IdentityExtensionHolder){
          return ((IdentityExtensionHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "IdentityExtension", original_type);
    }
    return _type;
  };
