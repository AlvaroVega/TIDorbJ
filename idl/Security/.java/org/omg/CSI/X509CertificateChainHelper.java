//
// X509CertificateChainHelper.java (helper)
//
...
abstract public class X509CertificateChainHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new X509CertificateChainHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof X509CertificateChainHolder){
          return ((X509CertificateChainHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "X509CertificateChain", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/CSI/X509CertificateChain:1.0";
  };
