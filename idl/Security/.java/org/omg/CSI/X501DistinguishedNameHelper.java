//
// X501DistinguishedNameHelper.java (helper)
//
...
abstract public class X501DistinguishedNameHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new X501DistinguishedNameHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof X501DistinguishedNameHolder){
          return ((X501DistinguishedNameHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "X501DistinguishedName", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/CSI/X501DistinguishedName:1.0";
  };
