...
abstract public class OIDListHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      org.omg.CORBA.TypeCode original_type = _orb().create_sequence_tc(0 , org.omg.CSI.OIDHelper.type());
  ...
  public static byte[][] read(org.omg.CORBA.portable.InputStream is) {
    byte[][] result;
      ...
      for (int i0=0; i0<length0; i0++) {
        result[i0] = org.omg.CSI.OIDHelper.read(is);
      }
    return result;
  };
  ...
  public static void write(org.omg.CORBA.portable.OutputStream os, byte[][] val) {
      ...
      for (int i0=0; i0<val.length; i0++) {
        org.omg.CSI.OIDHelper.write(os,val[i0]);
      }
  };
