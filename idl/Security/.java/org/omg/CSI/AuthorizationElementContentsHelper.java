//
// AuthorizationElementContentsHelper.java (helper)
//
...
abstract public class AuthorizationElementContentsHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new AuthorizationElementContentsHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof AuthorizationElementContentsHolder){
          return ((AuthorizationElementContentsHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "AuthorizationElementContents", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/CSI/AuthorizationElementContents:1.0";
  };
