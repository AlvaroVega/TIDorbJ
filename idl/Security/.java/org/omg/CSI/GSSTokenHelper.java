...
abstract public class GSSTokenHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new GSSTokenHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof GSSTokenHolder){
          return ((GSSTokenHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "GSSToken", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/CSI/GSSToken:1.0";
  };
