//
// AuthorizationElementTypeHelper.java (helper)
//
...
abstract public class AuthorizationElementTypeHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "AuthorizationElementType", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/CSI/AuthorizationElementType:1.0";
  };
