//
// GSS_NT_ExportedNameHelper.java (helper)
//
...
abstract public class GSS_NT_ExportedNameHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new GSS_NT_ExportedNameHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof GSS_NT_ExportedNameHolder){
          return ((GSS_NT_ExportedNameHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "GSS_NT_ExportedName", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/CSI/GSS_NT_ExportedName:1.0";
  };
