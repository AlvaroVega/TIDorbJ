//
// MechanismTypeListHelper.java (helper)
//
...
abstract public class MechanismTypeListHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, java.lang.String[] value) {
    any.insert_Streamable(new MechanismTypeListHolder(value));
  };
  ...
  public static java.lang.String[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof MechanismTypeListHolder){
          return ((MechanismTypeListHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      org.omg.CORBA.TypeCode original_type = _orb().create_sequence_tc(0 , org.omg.Security.MechanismTypeHelper.type());
      _type = _orb().create_alias_tc(id(), "MechanismTypeList", original_type);
    }
    return _type;
  };
  ...
  public static java.lang.String[] read(org.omg.CORBA.portable.InputStream is) {
    java.lang.String[] result;
      ...
      for (int i0=0; i0<length0; i0++) {
        result[i0] = org.omg.Security.MechanismTypeHelper.read(is);
      }
    return result;
  };
  ...
  public static void write(org.omg.CORBA.portable.OutputStream os, java.lang.String[] val) {
      ...
      for (int i0=0; i0<val.length; i0++) {
        org.omg.Security.MechanismTypeHelper.write(os,val[i0]);
      }
  };
