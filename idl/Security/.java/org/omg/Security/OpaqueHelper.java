...
abstract public class OpaqueHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, byte[] value) {
    any.insert_Streamable(new OpaqueHolder(value));
  };
  ...
  public static byte[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof OpaqueHolder){
          return ((OpaqueHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "Opaque", original_type);
    }
    return _type;
  };
