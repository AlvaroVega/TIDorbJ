//
// CodecFactoryHelper.java (helper)
//
...
abstract public class CodecFactoryHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      _type = _orb().create_interface_tc(id(), "CodecFactory");
    }
    return _type;
  }
  ...
  public static void insert(org.omg.CORBA.Any any, CodecFactory value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static CodecFactory extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    CodecFactory value = narrow(obj);
    return value;
  };

  public static CodecFactory read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, CodecFactory val) {
  ...
  private static CodecFactory narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof CodecFactory) {
