//
// MultipleComponentProfileHelper.java (helper)
//
...
abstract public class MultipleComponentProfileHelper {
  ...
  public static void insert(org.omg.CORBA.Any any, org.omg.IOP.TaggedComponent[] value) {
    any.insert_Streamable(new MultipleComponentProfileHolder(value));
  };
  ...
  public static org.omg.IOP.TaggedComponent[] extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        ...
        if(holder instanceof MultipleComponentProfileHolder){
          return ((MultipleComponentProfileHolder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "MultipleComponentProfile", original_type);
    }
    return _type;
  };
