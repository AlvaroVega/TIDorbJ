//
// ProfileBody_1_1Helper.java (helper)
//
...
abstract public class ProfileBody_1_1Helper {

  private static org.omg.CORBA.ORB _orb() {
    return org.omg.CORBA.ORB.init();
  }

  public static void insert(org.omg.CORBA.Any any, ProfileBody_1_1 value) {
    any.insert_Streamable(new ProfileBody_1_1Holder(value));
  };

  public static ProfileBody_1_1 extract(org.omg.CORBA.Any any) {
    if(any instanceof es.tid.CORBA.Any) {
      try {
        org.omg.CORBA.portable.Streamable holder =
          ((es.tid.CORBA.Any)any).extract_Streamable();
        if(holder instanceof ProfileBody_1_1Holder){
          return ((ProfileBody_1_1Holder) holder).value;
        }
      } catch (Exception e) {}
    }
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      members[4] = new org.omg.CORBA.StructMember("components", _orb().create_sequence_tc(0 , org.omg.IOP.TaggedComponentHelper.type()), null);
      _type = _orb().create_struct_tc(id(), "ProfileBody_1_1", members);
    }
    return _type;
  };
  ...
  public static ProfileBody_1_1 read(org.omg.CORBA.portable.InputStream is) {
    ProfileBody_1_1 result = new ProfileBody_1_1();
    ...
    result.port = is.read_ushort();
      ...
      result.components = new org.omg.IOP.TaggedComponent[length8];
      for (int i0=0; i0<length8; i0++) {
        result.components[i0] = org.omg.IOP.TaggedComponentHelper.read(is);
      }
    return result;
  };

  public static void write(org.omg.CORBA.portable.OutputStream os, ProfileBody_1_1 val) {
    ...
    os.write_ushort(val.port);
      ...
      os.write_ulong(val.components.length);
      for (int i0=0; i0<val.components.length; i0++) {
        org.omg.IOP.TaggedComponentHelper.write(os,val.components[i0]);
      }
  };
