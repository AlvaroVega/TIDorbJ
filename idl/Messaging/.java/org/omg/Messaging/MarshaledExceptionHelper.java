//
// MarshaledExceptionHelper.java (helper)
//
...
abstract public class MarshaledExceptionHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "MarshaledException", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:omg.org/MarshaledException:1.0";
  };
